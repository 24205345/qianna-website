...
const tripDetails = [
  { label: "Date", value: "2024.9.3" },
  { label: "Location", value: "Nanjiluo, Yunnan, China" },
  { label: "Activity", value: "Hiking" },
];

const photos = [
  { filename: "00_nanjiluo_cover.jpg", title: "Cover" },
  ...Array.from({ length: 16 }, (_, i) => ({ filename: `${(i + 1).toString().padStart(2, '0')}_nanjiluo_hike_${i + 1}.jpg`, title: `Hike ${i + 1}` })),
];

export default function NanjiluoPage() {
  return (
    <div className="min-h-screen bg-stone-50 text-stone-700 font-sans">
      {/* Hero Cover */}
      <section className="relative h-screen w-full overflow-hidden">
        <Image
          src="/field-notes/nanjiluo/images/00_nanjiluo_cover.jpg"
          alt="Nanjiluo cover"
          fill
          priority
      ...
      <section className="border-t border-stone-200">
        <div className="mx-auto w-full max-w-5xl px-6 py-14 md:px-10">
          <p className="text-[10px] tracking-[0.26em] text-stone-400 uppercase mb-8">Photos · 17</p>
          <PhotoGallery photos={photos} basePath="/field-notes/nanjiluo/images" />
        </div>
      </section>
