      ...
      <header className="relative min-h-screen w-full overflow-hidden">
        ...
        <div className="pointer-events-none relative z-10 flex min-h-screen items-end">
          <div className="w-full px-4 pb-12 md:px-8 md:pb-16 lg:px-12 lg:pb-18">
            <h1 className="hero-text-enter font-serif text-4xl text-stone-50 md:text-6xl">
              {siteSettings.heroTitle}
            </h1>
            <p className="hero-text-enter hero-text-enter-delay-1 mt-4 ml-1 max-w-2xl text-base leading-7 text-stone-100 md:text-lg">
